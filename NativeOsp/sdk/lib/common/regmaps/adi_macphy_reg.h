...
#include <stdint.h>
extern uint32_t ganMACPHYRegAddr[MACPHY_NUM_REGS];
extern uint32_t ganMACPHYNwRegAddr[MACPHY_NUM_REGS];
extern uint32_t ganMACPHYRegMMS[MACPHY_NUM_REGS];
extern uint32_t ganMACPHYRegResetVal[MACPHY_NUM_REGS];
extern const char *gasMACPHYRegName[MACPHY_NUM_REGS];
#endif
...
#define BITM_MAC_CONFIG0_RXCTE                                              (0x00000100u)
// Enums
...
#define BITM_MAC_CONFIG0_TXCTE                                              (0x00000200u)
// Enums
...
// |       |                          | is Empty.                         |             |
// +-------+--------------------------+-----------------------------------+-------------+
// | 13    | FWD_UNK2GPTP             | Forward Frames Not Matching a     | 0x00000001  |
// |       |                          | MAC Addr to gPTP                  |             |
// +-------+--------------------------+-----------------------------------+-------------+
...
// Bit field: FWD_UNK2GPTP
// Bit position, length and mask
#define BITP_MAC_CONFIG2_FWD_UNK2GPTP                                               (13u)
#define BITL_MAC_CONFIG2_FWD_UNK2GPTP                                                (1u)
#define BITM_MAC_CONFIG2_FWD_UNK2GPTP                                       (0x00002000u)
// Enums
#define ENUM_MAC_CONFIG2_FWD_UNK2GPTP_DISABLE                               (0x00000000u)
#define ENUM_MAC_CONFIG2_FWD_UNK2GPTP_ENABLE                                (0x00000001u)

// Bit field: LO_PRIO_FIFO_CRC_APPEND
// Bit position, length and mask
...
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
// Register Name        : TX_PRI
// Register Addr        : 0x0035u
// Register NW Addr     : 0xC035u
// Register Reset Value : 0x00000000u
// Register MMS         : 1u

#define MAC_TX_PRI_ADDR                                                         (0x0035u)
#define MAC_TX_PRI_NW_ADDR                                                      (0xC035u)
#define MAC_TX_PRI_RESET_VAL                                                (0x00000000u)
#define MAC_TX_PRI_MMS                                                               (1u)
#define MAC_TX_PRI_VOL_MASK                                                 (0x00000000u)

// Bit field description table:
// +=======+==========================+===================================+=============+
// | Bits  | Bit Field                | Description                       | Value       |
// +=======+==========================+===================================+=============+
// | 02-00 | TX_HOST_PRI              | Host Transmit Priority.           | 0x00000000  |
// +-------+--------------------------+-----------------------------------+-------------+

// Bit field defines:

// Bit field: TX_HOST_PRI
// Bit position, length and mask
#define BITP_MAC_TX_PRI_TX_HOST_PRI                                                  (0u)
#define BITL_MAC_TX_PRI_TX_HOST_PRI                                                  (3u)
#define BITM_MAC_TX_PRI_TX_HOST_PRI                                         (0x00000007u)
// Enums
#define ENUM_MAC_TX_PRI_HIGH_TX_HOST_PRI_50H_50L                            (0x00000000u)
#define ENUM_MAC_TX_PRI_HIGH_TX_HOST_PRI_75H_25L                            (0x00000002u)
#define ENUM_MAC_TX_PRI_HIGH_TX_HOST_PRI_87_5H_12_5L                        (0x00000004u)
#define ENUM_MAC_TX_PRI_HIGH_TX_HOST_PRI_100H_0L                            (0x00000005u)
...
#ifdef TEST_REG
//~~~~~~~~ TEST ~~~~~~~~
extern void FillMACPHYRegsData();
#endif
